...
module Guard
  ...
  class << self
    # source://guard/2.16.2/lib/guard.rb#87
    def async_queue_add(changes); end

    # source://guard/2.16.2/lib/guard.rb#73
    def init(cmdline_options); end

    # source://guard/2.16.2/lib/guard.rb#24
    def interactor; end

    # source://guard/2.16.2/lib/guard.rb#23
    def listener; end

    # source://guard/2.16.2/lib/guard.rb#22
    def queue; end

    # source://guard/2.16.2/lib/guard.rb#44
    def setup(cmdline_options = T.unsafe(nil)); end

    # source://guard/2.16.2/lib/guard.rb#21
    def state; end

    private

    # source://guard/2.16.2/lib/guard.rb#132
    def _evaluate(options); end

    # source://guard/2.16.2/lib/guard.rb#152
    def _guardfile_deprecated_check(modified); end

    # source://guard/2.16.2/lib/guard.rb#113
    def _listener_callback; end

    # source://guard/2.16.2/lib/guard.rb#128
    def _pluginless_guardfile?; end

    # source://guard/2.16.2/lib/guard.rb#109
    def _relative_pathnames(paths); end

    # source://guard/2.16.2/lib/guard.rb#99
